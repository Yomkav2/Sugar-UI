...
function Window.new(title)
    ...
    function selfObj:Show()
        ...
        SugarUI.Tween(OuterFrame, {Position = UDim2.new(0.5, -250, 0.5, -200)}, 0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out)
        SugarUI.Tween(Frame, {BackgroundTransparency = 0}, 0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.Out)
    ...
    function selfObj:Hide()
        ...
        SugarUI.Tween(OuterFrame, {Position = UDim2.new(0.5, -250, 0.5, -200 + 24)}, 0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.In)
