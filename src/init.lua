...
function ButtonComponent.new(parent, text, callback)
    ...
    Btn.MouseEnter:Connect(function()
        SugarUI.Tween(Btn, {BackgroundColor3 = SugarUI.Theme.ButtonHover, Size = UDim2.new(1, -6, 0, 40)}, 0.15)
    end)
    Btn.MouseLeave:Connect(function()
        SugarUI.Tween(Btn, {BackgroundColor3 = SugarUI.Theme.Button, Size = UDim2.new(1, -10, 0, 40)}, 0.15)
    end)
...
function Window.new(title)
    ...
    function selfObj:Show()
        ...
        SugarUI.Tween(Frame, {BackgroundTransparency = 0.06}, 0.5)
